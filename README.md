...
```php
// image to place markers on. 'base_image' is the name of the file field that holds our 'marked' image.
$out = '<img src="'. $page->base_image->url . '" alt="">';
